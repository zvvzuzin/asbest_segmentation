...
class Inference_model:
    def __init__(self, path_to_model = 'weights.pth'):
        self.model = smp.Unet(encoder_name='efficientnet-b3', encoder_weights='imagenet', in_channels=1, classes=2,  activation='sigmoid').to(device)
